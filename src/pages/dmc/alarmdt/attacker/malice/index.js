...
export default function Trojan() {
  ...
  const columns = [
    ...
    {
      title: language('alarmdt.attacker.filetype'),
      dataIndex: 'malfiletype',
      key: 'malfiletype',
      width: '100px',
      ellipsis: true,
      align: 'left',
    ...
    {
      title: language('alarmdt.attacker.filename'),
      dataIndex: 'malfilename',
      key: 'malfilename',
      width: '100px',
      ellipsis: true,
      align: 'left',
    ...
    {
      title:language('alarmdt.attacker.app'),
      dataIndex: 'app',
      key: 'app',
      width: '100px',
      ellipsis: true,
