...
export default function Trojan() {
  ...
  const trojantypeMap = {
    special:language('alarmdt.attacker.special'),
    normal:language('alarmdt.attacker.normal'),
    remotectrl:language('alarmdt.attacker.remotectrl'),
    other:language('alarmdt.attacker.other'),
  }
  const columns = [
    {
    ...
    {
      title: language('alarmdt.attacker.trojantype'),
      dataIndex: 'trojantype',
      key: 'trojantype',
      width: '80px',
      align: 'center',
      render:(text)=>{
        return (
          <Tag color='red'>{trojantypeMap[text]}</Tag>
        )
      }
    },
    {
      title: language('alarmdt.attacker.trojanname'),
      dataIndex: 'trojanname',
      key: 'trojanname',
      width: '100px',
      ellipsis: true,
      align: 'left',
    ...
    {
      title: language('alarmdt.attacker.trojanclass'),
      dataIndex: 'trojanid',
      key: 'trojanid',
      width: '100px',
      ellipsis: true,
